  ...
  return (
    ...
    >
      <div className="chart-header">
        ...
        <p className="chart-subtitle">Steady growth in digital dollar adoption</p>
      </div>
        ...
        <svg width="100%" height="200" viewBox="0 0 300 200" className="w-full">
          <defs>
            <linearGradient id="chartGradient" x1="0%" y1="0%" x2="0%" y2="100%">
              <stop offset="0%" style={{stopColor:'#007ea7', stopOpacity:0.8}} />
              <stop offset="100%" style={{stopColor:'#007ea7', stopOpacity:0.1}} />
            </linearGradient>
            <linearGradient id="lineGradient" x1="0%" y1="0%" x2="100%" y2="0%">
              <stop offset="0%" style={{stopColor:'#007ea7', stopOpacity:1}} />
              <stop offset="50%" style={{stopColor:'#80ced7', stopOpacity:1}} />
              <stop offset="100%" style={{stopColor:'#9ad1d4', stopOpacity:1}} />
            </linearGradient>
          </defs>
